...
MotorDrv::L298Nsingle(int L298Ntc, int pwm, int pos, int neg, float L298Nintensity ){
    L298Nintensity = (L298Nintensity * .01) ; // Turning intensity into an easy to use multiplier
...
MotorDrv::IBT2single(int tc, int pwml, int pwmr, int enl, int enr, float IBT2intensity ){
    ...
    IBT2intensity = (IBT2intensity * .01) ; // Turning intensity into an easy to use multiplier
...
MotorDrv::stepperKill(int in1, int in2, int in3, int in4){
