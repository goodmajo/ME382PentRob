...
#define pullInt1 40   // Pull Int1 on L298N
#define pullInt2 42   // Pull Int2 on L298N
#define pullInt3 44   // Pull Int3 on L298N
#define pullInt4 46   // Pull Int4 on L298N
...
Stepper pull(stepsPerRevolution, pullInt1, pullInt2, pullInt3, pullInt4) ;
...
void setup() {
  ...
  pinMode(pullInt1, OUTPUT) ;
  pinMode(pullInt2, OUTPUT) ;
  pinMode(pullInt3, OUTPUT) ;
  pinMode(pullInt4, OUTPUT) ;
  pull.setSpeed(60);
...
*/
    ...
    pull.step(pullMove/4) ; // I am seriously limiting the steps taken by the stepper, just to start with. If it's too little, I can always step it up. Better safe then sorry!
    }
    else(pull.step(0)) ;
