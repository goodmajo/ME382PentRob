...
// Now for the stepper. Documentation on these functions is really good and I won't be using them in any revolutionary new fashion.
 ...
 */
  ...
  */
    ...
    robot.IBT2( xmch2, xmch3, ldpwml, ldpwmr, rdpwml, rdpwmr, 100 ) ;     
    }
